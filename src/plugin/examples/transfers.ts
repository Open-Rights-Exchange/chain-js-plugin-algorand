...
const payRawTransaction: any = {
  txn: {
    ...
    snd: [
      168, 101, 164, 68, 116, 110, 137, 242, 164, 216, 34, 161, 122, 2, 23, 221, 236, 191, 81, 161, 78, 114, 147, 135,
      226, 72, 217, 99, 209, 87, 1, 164,
    ],
    type: 'pay',
    gen: 'testnet-v1.0',
    gh: [
    ...
    rcv: [
      153, 124, 244, 219, 245, 145, 20, 62, 130, 248, 101, 46, 94, 224, 204, 120, 233, 96, 166, 17, 57, 248, 252, 37,
      18, 43, 238, 6, 35, 95, 121, 176,
    ],
  },
}
